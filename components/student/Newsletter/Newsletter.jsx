...
const Newsletter = () => {
    return (
        <div id="join-section" className='-mt-32 relative z-10'>
            <div className="mx-auto max-w-2xl py-16 md:py-24 px-4 sm:px-6 md:max-w-7xl lg:px-24 bg-orange-1 rounded-lg bg-newsletter-1">
                <div className="grid grid-cols-1 gap-y-10 gap-x-6 sm:grid-cols-2 xl:gap-x-8">
                    ...
                    <div>
                        ...
                        <div className="flex gap-2">
                            ...
                            <button className="bg-purple-1 hover:bg-blue-700 text-white font-medium py-2 px-4 rounded">
                                Subscribe
                            </button>
                        </div>
                    </div>
